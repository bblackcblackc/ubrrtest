...
CREATE USER 'bnk'@'%' IDENTIFIED BY 'wdRbbQtpdf';
GRANT ALL ON bnk.* TO 'bnk'@'%';
...
--
-- Table structure for table `input_queries`
--

DROP TABLE IF EXISTS `input_queries`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `input_queries` (
...
--
-- Table structure for table `processed_info`
--

DROP TABLE IF EXISTS `processed_info`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `processed_info` (
  ...
  `advert_id` bigint(20) NOT NULL,
  `data` text COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`response_id`,`advert_id`)
...
-- Dump completed on 2017-07-04 23:06:47
